...
application = Application.builder().token("5965897880:AAHwEJqt5Axjg_TpL3c-fys78nJ7vFRqeF0").build()
...
def gpt(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    """gpt모듈을 호출하는것."""
    print (update.message.text)
    update.message.reply_text("......") #gpt 모듈이 응답을 준비하는동한 메세지로 ......을 보냄
    userPrompt = update.message.text
    gptresult = callgpt4.Command(userPrompt)
    update.message.reply_text(gptresult) #gpt모듈의 답변을 메세지로 보냄
